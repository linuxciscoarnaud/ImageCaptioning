...
public class Params {
	...
	private long seed = 1234; // Integer for reproducibility of a random number generator
	private Random rng = new Random(seed);
	
	private int sequenceVectorSize = 92;
	private int maxCharForOutputs = 299;
	...
	public String getTestImageDataDir() {
